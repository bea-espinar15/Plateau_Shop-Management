...
public class ListarVentasPorEmpleadoTableModel extends AbstractTableModel {
	
	private static final long serialVersionUID = 1L;
	
	private String[] columnNames = {"ID", "Fecha", "Precio total", "Metodo pago", "ID Cliente"};
	private ArrayList<TVenta> ventas;

	public ListarVentasPorEmpleadoTableModel(ArrayList<TVenta> aux) {
		this.ventas = aux;
	}
