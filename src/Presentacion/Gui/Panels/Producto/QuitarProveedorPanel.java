...
public class QuitarProveedorPanel extends GeneralPanel {

	private static final long serialVersionUID = 1L;

	private static QuitarProveedorPanel instance;
	private Panel_Main_Producto parent;
	JTextField idProductoField, idProveedorField;

	private QuitarProveedorPanel() {
		initGUI();
	}
	...
	private void initGUI() {
		...
		JLabel titleLbl = new JLabel("QUITAR PROVEEDOR");
		...
		annadirBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (validation()) {
					...
					Context request = new Context(ContextEnum.QUITARPROVEEDOR, new Pair(
	...
	public static QuitarProveedorPanel getInstance() {
		if (instance == null) {
			instance = new QuitarProveedorPanel();
		}
		return instance;
	}
	...
	public void update(Object o) {
		if (hasError(o)) {
			...
			JOptionPane.showMessageDialog(parent, "Asociacion eliminada con exito");
			clear();
		}
	}
